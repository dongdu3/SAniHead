...
def train_model():
	...
	model = SAniHeadEnd2End(sess=sess, epochs=20, lr=5e-6, data_root='/home/dudong/data/SAniHead/',
...
def test_model():
	...
	# 						checkpoint_dir='./checkpoint', sample_dir='./sample', log_dir='./logs', test_dir='./test')
	model = SAniHeadEnd2End(sess=sess, epochs=20, lr=1e-5, data_root='/home/dudong/data/SAniHead/',
							checkpoint_dir='./checkpoint', sample_dir='./sample', log_dir='./logs', test_dir='./test')
	model.test()
