...
CArcBall::CArcBall()
{
	...
	qOne.w = 1.f;
	glCurTransX = glCurTransY = glCurTransZ = 0.0;
...
void CArcBall::TransMouseDown(int px, int py, int nWinWidth, int nWinHeight)
{
	HVect v = convert(px, py, nWinWidth, nWinHeight);
	glDownX = v.x;
	glDownY = v.y;
...
void CArcBall::TransMouseMove(int px, int py, int nWinWidth, int nWinHeight)
{
	HVect v = convert(px,py, nWinWidth, nWinHeight);

	glCurTransX = v.x - glDownX;
	glCurTransY = v.y - glDownY;

}

void CArcBall::TransMouseUp(int px, int py, int nWinWidth, int nWinHeight)
{
	HVect v = convert(px,py, nWinWidth, nWinHeight);
