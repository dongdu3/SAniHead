...
/*#include "GL/glew.h"*/  // if not here,some functions such as glDeleteBuffers will not be found
#include <math.h>
...
private:
     void MouseMove(int px, int py, int nWinWidth, int nWinHeight);
	  ...
	  void TransMouseMove(int px, int py, int nWinWidth, int nWinHeight);
	  void TransMouseDown(int px, int py, int nWinWidth, int nWinHeight);
	  void TransMouseUp(int px, int py, int nWinWidth, int nWinHeight);
...
public:
		...
		void TransMouseDown(QPoint point)
		{
			TransMouseDown(point.x(),point.y(),m_nWinWidth, m_nWinHeight);
		}
		void TransMouseUp(QPoint point)
		{
			TransMouseUp(point.x(),point.y(),m_nWinWidth, m_nWinHeight);
		}
		void TransMouseMove(QPoint point)
		{
			TransMouseMove(point.x(),point.y(),m_nWinWidth, m_nWinHeight);
		}

public:
		GLfloat glDownX,glDownY,glDownZ;
		GLfloat glCurTransX,glCurTransY,glCurTransZ;
		GLfloat glTransX,glTransY,glTransZ;
