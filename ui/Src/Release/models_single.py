...
class Model(object):
    def __init__(self, **kwargs):
        ...
        self.model_path = os.path.join('./utils/', 'checkpoint_single')
...
class SAniHead(Model):
    def __init__(self, sess=None, init_infor_file='utils/sphere/init_info.dat', img_size=224, hidden=192, feat_dim=963,
        ...
        self.in_sket = tf.placeholder(tf.float32, shape=(self.img_size, self.img_size, 3), name='in_sket')  # input sketch image
